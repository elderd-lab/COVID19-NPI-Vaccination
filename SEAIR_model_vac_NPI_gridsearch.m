...
R0 = 10; %2.7; % 2.7 95% CI (1.6, 3.9) Davies et al - Lancet Public Health;
...
epi = 0.50; % efficacy of NPI [Could vary as well]
...
ratio = 0.1:0.05:5.0; % ratio of non_NPI/NPI vaccination rate
...
figure
contourf(ratio,alpha,Ymax/N0,20)
title('Ymax - infecteds')
...
figure
contourf(ratio,alpha,Zmax/N0,20)
title('Zmax - recovered')
ylabel('alpha, prop practicing NPI'); xlabel('ratio of Non-NPI/NPI Vac');
colormap('parula');
hcb = colorbar;
